...
typedef struct xmlAttlist xmlAttlist_t;
...
struct xmlAttlist{
    ...
    char* value;             //  VALEUR PAR DEFAULT, PEUT ETRE NULL
};

//  ELEMENT
struct xmlElement{
    char* name;
    xmlAttlist_t* attlist;          //  POINTEUR VERS L'ATTRIBUT ASSOCIE A L'ELEMENT, PAR DEFAULT NULL
    enum{
